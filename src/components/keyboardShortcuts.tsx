...
const KeyboardShortcuts = () => {
  ...
  const goToShortcut = (index: number) => {
    ...
    if ((wrapperRef.current.parentElement?.clientWidth as number) > 0) {
  ...
  return (
    <>
      <div
        ...
        className="mask-keyboard absolute top-0  left-12 h-full max-h-[35rem] w-[200%] md:relative md:left-auto md:w-full "
      >
